...
public class LocTagListAdapter extends MyBaseAdapter<Tag> {
    public LocTagListAdapter(ArrayList<Tag> list, Context context) {
        super(list, context, R.layout.item_loc_tag);
    }

    @Override
    protected void populateItemView(BaseViewHolder viewHolder, Tag item) {
