...
public class LocationExpandedListAdapter extends BaseExpandableListAdapter {
    private Context mContext;
    private ArrayList<LocRecordGroupItem> mGroupList;
    private LocRecordEditCallBack mCallBack;

    public LocationExpandedListAdapter(Context context, ArrayList<LocRecordGroupItem> groupList, LocRecordEditCallBack callBack) {
        mContext = context;
