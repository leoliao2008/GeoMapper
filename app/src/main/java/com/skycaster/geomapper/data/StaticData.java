...
public interface StaticData {
    ...
    String TEST_LINE_2="$GNGGA,034231.00,2234.8432929,N,11355.9788411,E,5,16,1.5,23.4319,M,-3.545,M,01,0004*7C";
    String TEST_LINE_3="$GNGGA,061925.00,2234.22237929,N,11356.24770956,E,5,05,2.8,49.872,M,-3.475,M,0.0,0693*6B";
    ...
    String EXTRA_BYTES_BEI_DOU_SERIAL_PORT_DATA = "EXTRA_BYTES_BEI_DOU_SERIAL_PORT_DATA";
    String ACTION_SEND_BEIDOU_SP_DATA = "ACTION_SEND_BEIDOU_SP_DATA";
    ...
    int BEI_DOU_MODULE_SP_BAUD_RATE = 115200;
