...
public class Test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageView= (ImageView) findViewById(R.id.test_pic);

        String url="http://api.map.baidu.com/panorama/v2?mcode="+ Constants.BAIDU_SECURITY_CODE+"&ak="+Constants.BAIDU_AK+"&width=512&height=256&location=116.313393,40.04778&fov=180";
