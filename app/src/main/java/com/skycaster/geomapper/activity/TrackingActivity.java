...
public class TrackingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMapView = (TextureMapView) findViewById(R.id.activity_tracking_map_view);
    ...
    private void initRoadData() {
        ...
        markerOptions = new MarkerOptions().flat(true).anchor(0.5f, 0.5f).icon(BitmapDescriptorFactory
                .fromResource(R.drawable.ic_my_location)).position(polylines.get(0)).rotate((float) getAngle(0));
