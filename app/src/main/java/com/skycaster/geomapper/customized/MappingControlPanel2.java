...
import com.skycaster.geomapper.activity.MappingActivityPrePre;
...
public class MappingControlPanel2 extends FrameLayout {
    ...
    private MappingActivityPrePre mActivity;
    private TextView tv_pathLength;

    public MappingControlPanel2(@NonNull Context context) {
        this(context,null);
    }

    public MappingControlPanel2(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MappingControlPanel2(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    public void attachToMappingActivity(ArrayList<LatLng> list, MappingActivityPrePre activity){
        mActivity=activity;
        mLocations=list;
    }
